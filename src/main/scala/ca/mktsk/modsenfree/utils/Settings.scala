...
//  }
  ...
  val gameMethodToPatchName: String = properties.getProperty("gameMethodToPatchName")
  val gameMethodToPatchIndex: String = properties.getProperty("gameMethodToPatchIndex")
